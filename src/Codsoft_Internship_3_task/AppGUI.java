...
public class AppGUI extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == addButton) {
            ...
            String sql = "INSERT INTO student_info VALUES('" + studentIdField.getText() + "', '"
            ...
            String sql = "";
            switch (choice) {
                case 0 -> sql = "SELECT * FROM student_info ORDER BY first_name";
                case 1 -> sql = "SELECT * FROM student_info ORDER BY last_name";
                case 2 -> sql = "SELECT * FROM student_info ORDER BY major";
                default -> {
                }
            }
            try {
            ...
            String sql = "SELECT * FROM student_info WHERE " + column + " LIKE '%" + searchTerm + "%'";
            ...
            String sql = "SELECT * FROM student_info WHERE student_id = '" + studentId + "'";
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    sql = "UPDATE student_info SET " + column + " = '" + newValue + "' WHERE student_id = '" + studentId + "'";
